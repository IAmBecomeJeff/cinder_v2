...
#include "readkeyboard.h"	// REMOVE when live



void setup() {
	Serial.begin(SERIAL_BAUDRATE);		// REMOVE when live
	Serial.setTimeout(SERIAL_TIMEOUT);	// REMOVE when live
